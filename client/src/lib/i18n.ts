...
const en = {
  ...
  upload: {
    ...
    successDialogTitle: "Submission received",
    successDialogClose: "Close",
    successDialogAriaLabel: "Close submission status dialog",
  ...
  viewer: {
    ...
    animationDetected: "Animation detected",
    noAnimation: "No animation",
    playAnimation: "Play",
    pauseAnimation: "Pause",
    resetAnimation: "Reset animation",
    animationSelectLabel: "Select animation clip",
    currentAnimationLabel: "Current animation",
    animationClipFallback: (index: number) => `Animation ${index}`,
...
const zhCN: AppCopy = {
  ...
  upload: {
    ...
    successDialogTitle: "投稿已接收",
    successDialogClose: "关闭",
    successDialogAriaLabel: "关闭投稿状态弹窗",
  ...
  viewer: {
    ...
    loading: "加载模型预览中...",
    animationDetected: "已检测到动画",
    noAnimation: "无动画",
    playAnimation: "播放",
    pauseAnimation: "暂停",
    resetAnimation: "重置动画",
    animationSelectLabel: "选择动画片段",
    currentAnimationLabel: "当前动画",
    animationClipFallback: (index: number) => `动画 ${index}`,
