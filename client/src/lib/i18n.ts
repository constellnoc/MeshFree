...
const en = {
  ...
  admin: {
    ...
    previewConversionStatusLabel: "Preview conversion",
    previewConversionMessageLabel: "Conversion note",
    previewEnabledLabel: "Preview access",
    publicVisibilityLabel: "Public visibility",
    missingTexturesLabel: "Missing textures",
    sourceFormatValues: {
      obj: "OBJ",
      fbx: "FBX",
      dae: "DAE",
    ...
    previewConversionStatusValues: {
      not_attempted: "Not attempted",
      success: "Success",
      warning: "Warning",
      failed: "Failed",
    },
    previewEnabledValues: {
      enabled: "Enabled",
      disabled: "Disabled",
    },
    ...
    saveTags: "Save tags",
    createTagToggle: "Create public tag",
    createTagSectionTitle: "New public tag",
    createTagSectionLead: "Create a reusable public tag with both English and Chinese names.",
    tagSlugLabel: "Tag slug",
    tagSlugPlaceholder: "sci-fi-weapon-pack",
    tagNameEnLabel: "English name",
    tagNameEnPlaceholder: "Sci-Fi Weapon Pack",
    tagNameZhLabel: "Chinese name",
    tagNameZhPlaceholder: "科幻武器包",
    tagScopeLabel: "Tag scope",
    tagScopeValues: {
      broad: "Broad",
      medium: "Medium",
      specific: "Specific",
    },
    createTagSubmit: "Create tag",
    createFromRawTag: "Create public tag",
    resolveToExisting: "Bind to public tag",
    resolveSelectLabel: "Target public tag",
    resolveSelectPlaceholder: "Select a public tag",
    resolveConfirm: "Confirm binding",
    ignoreRawTag: "Ignore",
    cancelRawTagAction: "Cancel",
    rawTagStatusLabel: "Status",
    rawTagStatusValues: {
      pending: "Pending",
      resolved: "Resolved",
      ignored: "Ignored",
    ...
    requiredResolveTag: "Please select a public tag first.",
    successTagsSaved: "Submission tags updated successfully.",
    successTagCreated: "Admin tag created successfully.",
    successRawTagIgnored: "Custom tag ignored successfully.",
    successRawTagResolved: "Custom tag resolved successfully.",
    successRawTagConverted: "Custom tag converted successfully.",
...
const zhCN: AppCopy = {
  ...
  upload: {
    ...
    suggestedTagsLabel: "自定义标签",
    suggestedTagPlaceholder: "添加一个自定义标签",
    addSuggestion: "添加建议",
    suggestedTagsHelp: "自定义标签不会公开。仅管理员可决定将其转为新的公开标签，或作为现有标签的别名。",
    ...
    draftHelp: "文本字段、已选预设标签和自定义标签将保存在本地浏览器中。刷新或重置后需重新选择文件。",
    rulesTitle: "上传规则",
    ...
    suggestedTagsLimit: (maxTags: number) => `请最多使用 ${maxTags} 个自定义标签。`,
    tagLength: (minLength: number, maxLength: number) =>
  ...
  admin: {
    ...
    previewConversionStatusLabel: "预览转换状态",
    previewConversionMessageLabel: "转换说明",
    previewEnabledLabel: "在线预览开关",
    publicVisibilityLabel: "公开状态",
    missingTexturesLabel: "缺失贴图",
    sourceFormatValues: {
      obj: "OBJ",
      fbx: "FBX",
      dae: "DAE",
    ...
    saveTags: "保存标签",
    createTagToggle: "新建自有标签",
    createTagSectionTitle: "新建自有标签",
    createTagSectionLead: "创建一个可复用的公开标签，并同时填写英文名和中文名。",
    tagSlugLabel: "标签 slug",
    tagSlugPlaceholder: "sci-fi-weapon-pack",
    tagNameEnLabel: "英文名",
    tagNameEnPlaceholder: "Sci-Fi Weapon Pack",
    tagNameZhLabel: "中文名",
    ...
    createTagSubmit: "创建标签",
    createFromRawTag: "新建自有标签",
    resolveToExisting: "绑定到已有标签",
    resolveSelectLabel: "目标公开标签",
    resolveSelectPlaceholder: "选择一个公开标签",
    resolveConfirm: "确认绑定",
    ignoreRawTag: "忽略",
    cancelRawTagAction: "取消",
    rawTagStatusLabel: "状态",
    rawTagStatusValues: {
      pending: "待处理",
      resolved: "已处理",
      ignored: "已忽略",
    ...
    resolvedToLabel: "已归入",
    privateSuggestedTagsLabel: "私有自定义标签",
    privateSuggestedTagsHelp: "这些建议在审核前仅对管理员可见。",
    noPrivateSuggestedTags: "未提交私有自定义标签。",
    ...
    requiredResolveTag: "请先选择一个公开标签。",
    successTagsSaved: "投稿标签更新成功。",
    successTagCreated: "自有标签创建成功。",
    successRawTagIgnored: "自定义标签已忽略。",
    successRawTagResolved: "自定义标签已成功绑定。",
    successRawTagConverted: "自定义标签已成功转为自有标签。",
